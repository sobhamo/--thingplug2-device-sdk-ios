...
let HOST = Host(serviceName: "", deviceName: "", deviceToken: "", host:"", port: "8883", clientId: "", userName: nil, password: nil, usingSSL: true, cleanSession: true)

let CSV_HOST = Host(serviceName: "", deviceName: "", deviceToken: "", host:"", port: "8883", clientId: "", userName: "", password: nil, usingSSL: true, cleanSession: true)
